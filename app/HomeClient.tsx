...
export default function HomeClient() {
    ...
    return (
        <div className="bg-[#0a0a0a] text-white selection:bg-cyan-500 selection:text-black font-sans">
            {/* Navigation */}
            <nav className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/10" aria-label="Main navigation">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-2 font-bold text-xl tracking-tighter hover:opacity-80 transition-opacity" aria-label="BitnBolt home">
            ...
            {/* Hero Section */}
            <section ref={targetRef} className="relative h-screen flex items-center justify-center overflow-hidden pt-16" aria-label="Hero">
                ...
                <div className="absolute bottom-10 left-10 hidden md:block opacity-30 font-mono text-xs" aria-hidden="true">
                    <div>SYS_STATUS: ONLINE</div>
                    <div>CORE_TEMP: 42°C</div>
                </div>
                <div className="absolute bottom-10 right-10 hidden md:block opacity-30 font-mono text-xs text-right" aria-hidden="true">
            ...
            {/* Levels Section */}
            <section id="levels" className="py-20 md:py-32 relative bg-[#0a0a0a]" aria-labelledby="levels-heading">
                <div className="max-w-7xl mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-20"
                    >
                        <h2 id="levels-heading" className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">PROGRESSIVE MASTERY</h2>
            ...
            <section id="kit" className="py-20 md:py-32 bg-[#050505] border-y border-white/5" aria-labelledby="kit-heading">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 id="kit-heading" className="text-4xl md:text-6xl font-bold mb-8 tracking-tighter">
            ...
            <section id="curriculum" className="py-20 md:py-32 relative" aria-labelledby="curriculum-heading">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                        <div>
                            <h2 id="curriculum-heading" className="text-4xl md:text-5xl font-bold mb-4">STRUCTURED LEARNING</h2>
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            {['Twitter', 'GitHub', 'Discord'].map((social) => (
                                <a key={social} href="#" className="hover:text-white transition-colors" rel="noopener noreferrer">{social}</a>
                            ))}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link href="/learn" className="hover:text-cyan-400 transition-colors">Tutorials</Link></li>
