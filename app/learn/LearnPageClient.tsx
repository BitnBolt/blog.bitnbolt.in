            ...
            <div className="flex flex-1 pt-16 h-full overflow-hidden relative">
                ...
                `} aria-label="Course curriculum">
                    ...
                    <div className="md:hidden flex justify-between items-center p-4 border-b border-white/10">
                        ...
                        <button onClick={() => setIsMobileMenuOpen(false)} aria-label="Close curriculum menu">
                            <X className="w-6 h-6 text-gray-400" />
                        </button>
                    </div>

                    <div className="p-6 overflow-y-auto flex-1 pb-20 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                        <h2 className="hidden md:block font-bold text-gray-400 text-sm tracking-widest uppercase mb-6 pl-2">
                            Course Content
                        </h2>

                        <nav aria-label="Course chapters and modules">
                ...
                <main id="main-content" className="flex-1 md:ml-0 p-6 md:p-12 overflow-y-auto pb-32">
                    ...
                    >
                        {/* Breadcrumb */}
                        <nav aria-label="Module breadcrumb" className="flex flex-wrap items-center gap-2 mb-8 text-sm font-mono text-gray-500">
