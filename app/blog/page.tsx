    ...
    return (
        <div className="h-screen bg-[#0a0a0a] text-white flex flex-col font-sans overflow-hidden">
            ...
            <div className="flex flex-1 pt-16 h-full overflow-hidden">
                ...
                <aside className="w-64 border-r border-white/10 bg-[#0a0a0a] h-full overflow-hidden hidden md:flex flex-col shrink-0">
                ...
                <main className="flex-1 md:ml-0 p-6 md:p-12 h-full overflow-y-auto">
                    <div className="mb-8 flex items-end justify-between">
                        ...
                        <div className="md:hidden">
                            <button className="p-2 border border-white/10 text-gray-400">
                                ...
                                {filteredProjects.map((project) => (
                                    <Link href={`/blog/${project.id}`} key={project.id}>
                                        <motion.div
                                            ...
                                            className="group bg-[#0a0a0a] border border-white/10 hover:border-cyan-400/50 transition-all duration-300 flex flex-col h-[320px] relative overflow-hidden cursor-pointer"
                                        >
                                            {/* Image Placeholder */}
                                            <div className={`h-40 w-full ${project.image} relative overflow-hidden bg-cover bg-center`}>
                                                <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors" />
                                                <div className="absolute top-3 right-3 bg-black/50 backdrop-blur px-2 py-1 text-xs font-mono border border-white/10">
                                                    {project.level}
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-6 flex flex-col flex-1 overflow-hidden">
                                                ...
                                                <h3 className="text-xl font-bold mb-2 leading-tight group-hover:text-cyan-400 transition-colors line-clamp-1">
                                                    {project.title}
                                                </h3>
