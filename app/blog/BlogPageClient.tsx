    ...
    return (
        <div className="h-screen bg-[#0a0a0a] text-white flex flex-col font-sans overflow-hidden">
            ...
            <div className="flex flex-1 pt-16 h-full overflow-hidden relative">
                ...
                <main className="flex-1 md:ml-0 p-6 md:p-12 h-full overflow-y-auto" id="project-library">
                        ...
                        >
                            <AnimatePresence>
                                {filteredProjects.map((project) => (
                                    <Link href={`/blog/${project.slug}`} key={project.slug || project.id} aria-label={`Read project: ${project.title}`}>
                                        <motion.article
                                            layout
                                        ...
                                        >
                                            ...
                                            <div className="p-6 flex flex-col flex-1 overflow-hidden">
                                                ...
                                                <h2 className="text-xl font-bold mb-2 leading-tight group-hover:text-cyan-400 transition-colors line-clamp-2">
                                                    {project.title}
                                                </h2>
